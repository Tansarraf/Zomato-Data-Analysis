...
### This project performs Exploratory Data Analysis (EDA) on a Zomato restaurant dataset to uncover patterns related to restaurant types, pricing, ratings, votes, and online order availability. The goal is to extract meaningful business insights from raw restaurant data using Python data analysis and visualization libraries.
...
- Do higher votes indicate better quality (rating)?
- What price range is most common among restaurants?
- Does restaurant type influence online order preference?
